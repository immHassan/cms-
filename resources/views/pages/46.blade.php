...
<section class="custom_component" id="ickj"><div class="custom_component_ph"><img src="http://localhost/ministry/public//admin/custom_navbar.png" id="i79l"/></div><div class="custom_component_content" id="ix3w">
              @include("admin.cms.components.custom_navbar")
            </div></section><style>* { box-sizing: border-box; } body {margin: 0;}#ickj{border:4px dashed #7d7d7d;padding:10px;}#i79l{height:auto;width:100%;}#ix3w{display:none;}</style> 
