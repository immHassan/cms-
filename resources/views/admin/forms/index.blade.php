        ...
        <div class="card-header">
            ...
            <div class="card-options">
              <div class="input-group">
                @if(auth()->user()->can('form-write'))
                        <a href="{{route('forms.design_form')}}" class="btn btn-primary" >
                            <i class="fe fe-plus mr-2"></i>New Form</button>
                            </a>
                @endif    
