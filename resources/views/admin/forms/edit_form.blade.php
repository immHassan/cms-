      ...
      <div class="card">
        <div class="card-header">
            ...
            <div class="card-options">
              ...
              <a  href="javascript:void()" onclick="update_form()" class="btn btn-primary" >
              Update Form</button>
              </a>
            </div>  
            </div>
        ...
        <div class="card-body">
          ...
          <div class="container">
            ...
            <div class="container"> 
              ...
              <input type="text" class="form-control" value="{{$data->title}}" name="form_title">  
            ...
            <div class="container"> 
              ...
              <input type="text" class="form-control" value="{{$data->slug}}" name="form_slug">
            ...
            <div class="container"> 
              ...
              @foreach($service_list as $record)
                <option  @if($data->service_id == $record->id)  selected @endif   value="{{$record->id}}"> {{$record->title}} </option>
              @endforeach
              </select>
              <span id="service_id_err" class="text-danger laravel_validation"> </span>  
                ...
                <div class="row">
                    <div class="col-sm-3">      
                    <h4 class="ml-2 text-center"> Form Design</h4> 
                    ...
                    <div class="col-md-3 bal_builder">
                        ...
                        {!! $data->form_html_editable !!}
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="container">
                          <h4 class="text-center"> Design Preview</h4>   
...
return Text.toLowerCase()
  ...
  var keyValues = {!! $data->key_values !!}
  console.log("keyValues",keyValues);

  for (let k in keyValues) {
    
    $(`input[name=${k}]`).val(keyValues[k]);
