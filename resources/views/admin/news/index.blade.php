  ...
  <div class="container-fluid">
      <div class="card">
        <div class="card-header">
            <h3 class="card-title">{{__('languages.news')}} {{__('languages.list')}}</h3>
        ...
        <div class="card-body">
            <div class="table-responsive">
                ...
                @endif
                <th> <span>{{__('languages.is_featured')}}</span> </th>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content" style="width:120%">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel"> {{__('languages.news')}}</h5>
        <div class=""> 
    ...
    $.ajax(viewSettings).done(function(response) {
      if (response.status == false) {
        ...
        if(response.data.image_selection == 1){
          ...
          var src = 'uploads/news/'+response.data.image;
        ...
        var is_featured = document.getElementById('is_featured');
        var is_featured1 = is_featured.parentElement.parentElement.querySelectorAll('.on')[0];
