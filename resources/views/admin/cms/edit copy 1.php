...
<?php
    ...
    editor.Blocks.add('news-slider-block', {
      ...
      category: 'Components',
      attributes: { class: 'fa fa-file-o' },
      content: set_component('news_slider', 'News Slider')
    });
    ...
    editor.Blocks.add('custom_navbar-block', {
      ...
      category: 'Components',
      attributes: { class: 'fa fa-file-o' },
      content: set_component('custom_navbar', 'Navbar')
    });
    ...
    function set_component(id, placeholder) {
      ...
      return `<section style="border: 4px dashed #7d7d7d; padding:10px" class="custom_component" >
            <div class="custom_component_ph">
            <img style="height:auto; width:100%;" src='<?= asset("/") ?>/admin/${id}.png'>
            </div>
  ...
  <script>
    ...
    function saveCustomJs() {
      ...
      var iframe = $('iframe.gjs-frame');
      iframe.contents().find("head").append(customJsText);
